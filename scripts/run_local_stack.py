...
PLATFORM_STUB_DIR = REPO_ROOT / "packages" / "agent" / "python" / "rare-agent-sdk-python" / "tests"
PROTOCOL_SRC_DIR = REPO_ROOT / "packages" / "shared" / "python" / "rare-identity-protocol-python" / "src"
VERIFIER_SRC_DIR = REPO_ROOT / "packages" / "shared" / "python" / "rare-identity-verifier-python" / "src"
AGENT_SDK_SRC_DIR = REPO_ROOT / "packages" / "agent" / "python" / "rare-agent-sdk-python" / "src"
RUNTIME_DIR = REPO_ROOT / ".tmp-run" / "local-stack"

for candidate in (RARE_SERVICES_DIR, PLATFORM_STUB_DIR, PROTOCOL_SRC_DIR, VERIFIER_SRC_DIR, AGENT_SDK_SRC_DIR):
