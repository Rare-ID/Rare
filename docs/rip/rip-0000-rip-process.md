...
Replaces: None
Superseded-By: None
Discussion: https://github.com/Rare-ID/Rare/discussions
...
- Numbered RIPs MUST live in `docs/rip` and match `rip-XXXX-slug.md`.
- Draft RIPs MUST live in `docs/rip/drafts` and match `rip-draft-slug.md`.
...
Replaces: None
Superseded-By: None
Discussion: https://github.com/Rare-ID/Rare/issues/123
```

## Reference Implementation
- `docs/rip/RIP_TEMPLATE.md`
- `docs/rip/CONTRIBUTING_RIP.md`
- `docs/rip/RIP_INDEX.md`
